        ...
        <CardContent className="p-8 space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-startsnap-oxford-blue">Your Content</h3>
              <ul className="text-startsnap-river-bed leading-relaxed space-y-2 list-disc pl-6">
              ...
              <h3 className="text-lg font-semibold text-startsnap-oxford-blue">Prohibited Content</h3>
              <ul className="text-startsnap-river-bed leading-relaxed space-y-2 list-disc pl-6">
